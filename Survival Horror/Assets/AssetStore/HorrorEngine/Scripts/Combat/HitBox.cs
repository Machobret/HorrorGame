...
namespace HorrorEngine
{
    ...
    {
        public abstract void GetOverlappingDamageables(List<Damageable> damageables, bool showDebug);
    }
    ...
    public class HitBox : HitShape
    {
        ...
        public override void GetOverlappingDamageables(List<Damageable> damageables, bool showDebug)
        {
            damageables.Clear();
            ...
            if (showDebug)
                DebugUtils.DrawBox(boxOrigin, transform.rotation, Vector3.one, scaledSize, damageables.Count > 0 ? Color.green : Color.red, 3);
